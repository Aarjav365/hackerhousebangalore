  ...
  const renderLanding = () => (
    <div className="max-w-xl mx-auto pt-20 px-6 pb-20">
      ...
      <FadeIn delay={0.8}>
        ...
        {/* Team Application Guide link */}
        <div className="mt-20 pt-12 border-t border-gray-200 dark:border-gray-800 text-center">
          <p className="font-sans text-[10px] uppercase tracking-[0.2em] text-subtle dark:text-dark-subtle mb-4">
            Want to help build this?
          </p>
          <a
            href="/team"
            className="font-serif text-2xl md:text-3xl italic text-ink dark:text-dark-ink border-b border-ink dark:border-dark-ink pb-1 hover:opacity-70 transition-opacity"
          >
            Read the Team Application Guide →
          </a>
        </div>
      </FadeIn>
    </div>
